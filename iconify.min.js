...
var Iconify = function(e) {
    ...
    function b(e, n) {
        ...
        if ("string" != typeof n && (n = "string" == typeof e.provider ? e.provider : ""), h && "" === n && ("string" != typeof e.prefix || "" === e.prefix)) {
            var r = !1;
    ...
    function A(e, n) {
        ...
        })), null === n.width && null === n.height ? r = I(t = "1em", i.width / i.height) : null !== n.width && null !== n.height ? (r = n.width, t = n.height) : null !== n.height ? r = I(t = n.height, i.width / i.height) : t = I(r = n.width, i.height / i.width), "auto" === r && (r = i.width), "auto" === t && (t = i.height);
        var a = {
            attributes: {
            ...
            function r(n) {
                ...
                if (r) {
                    ...
                    try {
                        ...
                        for (var o = J(r), a = o - 1; a >= 0; a--) t(a) || (a === o - 1 ? o-- : _[n].push(a));
                        V(r, n, o)
                    } catch (e) {}
                }
            }
    ...
    for (var Z = Object.create(null), ee = ["https://api.simplesvg.com", "https://api.unisvg.com"], ne = []; ee.length > 0;) 1 === ee.length || Math.random() > .5 ? ne.push(ee.shift()) : ne.push(ee.pop());
    ...
    function ue() {
        if (null === oe) {
            var e = self,
                n = "Iconify",
                r = ".cb";
            if (void 0 === e[n]) r = "", void 0 === e[n = "IconifyJSONP"] && (e[n] = Object.create(null)), oe = e[n];
            else {
                var t = e[n];
    ...
    function Fe(e, n, r) {
        ...
        void 0 === t[n] ? t[n] = r : t[n] = t[n].concat(r).sort(), i[n] || (i[n] = !0, setTimeout((function() {
            ...
            a ? a.prepare(e, n, r).forEach((function(r) {
                ...
                Ce[r] < t && (Ce[r] = t, console.error('Unable to retrieve icons for "' + r + '" because API is not configured properly.'))
            }()
        })))
    }
    var Pe = function(e) {
        ...
        if (e.observer) {
            ...
            if (!r.pendingScan)
                for (var t = 0; t < n.length; t++) {
                    var i = n[t];
                    if (i.addedNodes && i.addedNodes.length > 0 || "attributes" === i.type && void 0 !== i.target[De]) return void(r.paused || Ve(e))
                }
        }
    }
    ...
    function Be(e) {
        ...
        if (!n || !n.instance) {
            ...
            r && (n || (n = {
                paused: 0
            }, e.observer = n), n.instance = new MutationObserver(Je.bind(null, e)), Ye(e, r), n.paused || Ve(e))
        }
    }
    ...
    function Ke(e) {
        var n = null !== $e;
        $e !== e && ($e = e, n && _e().forEach(Qe)), n ? Ge() : function(e) {
            var n = document;
            ...
            if (t && t.querySelectorAll) {
                ...
                an(t).forEach((function(n) {
                    var t, a, c = n.element,
                        ...
                        d = f.name,
                        p = c[Ne];
                    if (void 0 !== p && (t = p.name, a = f, null !== t && null !== a && t.name === a.name && t.prefix === a.prefix)) switch (p.status) {
                        case "missing":
                            return;
                        case "loading":
                            if (Pe({
    ...
    var vn = ["inline", "hFlip", "vFlip"],
        ...
        gn = {
            ...
            customisations: function(e, n) {
                ...
                if (-1 !== (i ? i.split(/\s+/) : []).indexOf(hn) && (t.inline = !0), ln(e, "data-rotate")) {
                    var o = function(e, n) {
                        void 0 === n && (n = 0);
                        var r = e.replace(/^-?[0-9.]*/, "");
                ...
                return ln(e, "data-flip") && (r = t, dn(e, "data-flip").split(sn).forEach((function(e) {
                    switch (e.trim()) {
                        case "horizontal":
                            r.hFlip = !0;
                            break;
                ...
                }(t, dn(e, "data-align")), vn.forEach((function(n) {
                    if (ln(e, "data-" + n)) {
                        var r = function(e, n) {
    ...
    if (K("", ve ? pe : se), "undefined" != typeof document && "undefined" != typeof window) {
        ...
        if (void 0 !== Mn.IconifyProviders) {
            ...
            if ("object" == typeof Sn && null !== Sn)
                for (var Tn in Sn) {
                    ...
                    try {
                        var Fn = Sn[Tn];
                        if ("object" != typeof Fn || !Fn || void 0 === Fn.resources) continue;
